...
public class LiskovSubstitution {
	...
	public static void main(String[] args) throws Exception{
		...
		PetShopInfoCenter.addProduct(new Dog(180, 100, 15, "If you Adopt Supplies are Free"));
...
abstract class Animal {
	...
	public String getCompletePrice() {
		...
		return "Animal Price: $" + this.baseprice + ".00 + Supplies Price: $" +
				this.suppliesprice + ".00\n\tTotal Price: $" + (this.baseprice + this.suppliesprice) + ".00";
...
class Dog extends Animal {
	...
	public String getExtraSupplies() {
		...
		return "\tObligatory: Vaccines, Food 50kg\t($" + 
				this.obligatorySuppliesprice + ".00)\n\t\tOptional: dog collar & harness\t($" +
